const Messages = {
  ...
  AUCTION_PARTICIPATE_UPDATED: "AuctionParticipate Updated Successfully",
  ...
  BID_FETCHED: "Bid Fetched Successfully",

  USER_TEAM_FETCHED: "Userteam Fetched Successfully",
